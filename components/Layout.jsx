    ...
    return (
        <>
            <nav className="nav">
                <Link href="/">
                    <a className="header">
                        <img className="icon" src={theme === "dark" ? "/magicswap.png" : "/magicswap.png"}></img>
                        <div className="title">MAGICAL SWAP</div>
                    </a>
                </Link>
    ...
    return (
        <>
            <div className="footer">
                ...
                <div className="links">
                    <a href="https://t.me/MagicalNetwork" target="_blank">
                        <img className="link" src="/icons/telegram.svg"></img>
                    </a>
                    <a href="https://github.com/MagicalNetwork" target="_blank">
