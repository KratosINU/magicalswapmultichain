...
const Metadata = ({ page }) => {
    const title = `MagicalSwap | Multi Chain Swap${page ? ` - ${page}` : ""}`
    return (
        <Head>
            <meta charSet="UTF-8"></meta>
            <meta name="viewport" content="width=device-width"></meta>
            <meta name="description" content="Magical Swap is the first utility in the Magical Network Ecosystem. Magical Swap provide the users the ability to swap any tokens with any chains in one dex."></meta>
            <meta property="og:title" content={title}></meta>
            <meta property="og:type" content="website"></meta>
            <meta property="og:image" content="/magicswap.png"></meta>
            <meta property="og:description" content="Magical Swap is the first utility in the Magical Network Ecosystem. Magical Swap provide the users the ability to swap any tokens with any chains in one dex."></meta>
            <title>{title}</title>
            <link rel="icon" href="/magicswap.png"></link>
        </Head>
    )
}
